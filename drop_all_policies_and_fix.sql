-- Drop ALL policies on violation tables and fix column types
-- This script will drop all policies regardless of their names
...
-- Recreate basic policies (simplified version)
